function timing_info_reading = Reading (w, Width, Height, subject_ID)
...
Instructions(w,'Read the words aloud \n Press SPACE to continue');
% %
...
timing_info_reading = [trial_length,length_clear_plus_active,length_clear_mind];
end


log_words (subject_ID,words_random,'reading');
